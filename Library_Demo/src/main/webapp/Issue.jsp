...
<link rel="stylesheet" href="CSS files/Issue.css">
<link rel="stylesheet"
...
<body>
	...
	<form action="UserHistoryController" method="post">
									...
									<tr>
										<th scope="row">
											<div class="d-flex align-items-center">
												<img src="bookicon.png" class="img-fluid rounded-3"
													style="width: 120px;" alt="Book">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<div class="flex-column ms-4">
													<p>
														<label class="form-label" for="typeText">Enter
															Email</label> <input type="email" id="typeText"
															placeholder="mail" name="usermail" required>
													</p>

													<p>
														<label class="form-label" for="typeText">Enter
															Book ID</label> <input type="number" id="typeText" placeholder="1234" 
															name="bookid" required>
													</p>
													<p>
														<label class="form-label" for="typeText">Enter
															Date</label> <input type="date" id="typeText" placeholder="1234"
															name="issuedate" >
													</p>
											...
											<div class="col-12 col-xl-6">
												<div class="form-outline mb-4 mb-xl-5">
													<input type="text" id="typeText"
														...
														placeholder="Arpit Chavan" minlength="19" maxlength="19" />
...
<!-- display return date -->
<!-- <button onclick="add()">Add</button> <div id="ans">:</div> --> 
	...
	<div class="footer my-footer">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<p>
					<a style="color: black" href="">OUR STORY</a><br> <br> <a
						style="color: black" href="">OUR PRODUCTS</a><br> <br> <a
						style="color: black" href="">FOUNDER'S STORY</a><br> <br>
					<a style="color: black" href="">CUSTOM ORDERS</a><br> <br>
				</p>
			</div>
			<div class="col-sm-2">
				<p>
					<a style="color: black" href="">FAQs</a><br> <br> <a
						style="color: black" href="">CAREERS</a><br> <br> <a
						style="color: black" href="">PRIVACY POLICY</a><br> <br>
					<a style="color: black" href="">DISCLAIMER</a><br> <br>
				</p>
			</div>
			<div class="col-sm-2">
				<p>
...
<!-- <script>
	var anslen = document.getElementById("ans");
	function add() {

		var newDate = Date.today().add(30).days();
		var data = arpit;
		console.log(newDate);
		anslen.innerDate = "Add is : " + data
	}
</script> -->
