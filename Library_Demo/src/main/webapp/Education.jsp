	...
	<br>
		...
		<div class="educational-booksflex" id="educational-books">
			<div class="card my-card-styling " style="width: 18rem;">
				<img src="./som.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Strength of Material</h5>
					<p class="card-text">A Book by R.K.Bansal</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1001</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="ms.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Material Science</h5>
					<p class="card-text">A Book by William Callister</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1002</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="machine design.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Machine Design</h5>
					<p class="card-text">Machine Design Data Book by V B Bhandari</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1003</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="heat mass trans.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title"> Heat and Mass Transfer</h5>
					<p class="card-text"> Heat and Mass Transfer by P.K. Nag</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1004</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="./industrial eng.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Industrial Engineering</h5>
					<p class="card-text">Industrial Engineering by Ravi Shankar </p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1005</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item"><h6 style="color: red ">Status : Not Available</h6></li>
				</ul>
				<div class="card-body">
					<center>
						<a href="Education.jsp" class="card-link">Issue</a>
					</center>
				</div>
			</div>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				...
				<div class="card-body">
					...
					<p class="card-text">Engineering Mathematics by Nirali Publication </p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 1006</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
