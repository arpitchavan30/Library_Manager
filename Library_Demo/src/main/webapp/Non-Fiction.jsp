	...
	<br>
		...
		<div class="educational-booksflex" id="educational-books">
			<div class="card my-card-styling " style="width: 18rem;">
				<img src="work and secret.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Secret Of Success</h5>
					<p class="card-text">Author : Swami Vivekananda</p>
					<p class="card-text">Publisher:	Ramkrishna Mathe</p>
					<p class="card-text">Language : Marathi</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5001</li>
					<li class="list-group-item">Charges per month(Rs) : 110</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="rutuchakra.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Rutuchakra</h5>
					<p class="card-text">Book by Durga Bhagwat</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5002</li>
					<li class="list-group-item">Charges per month(Rs) : 115</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
					<center>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="maharashtra.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Maharashtra</h5>
					<p class="card-text">An Excellent Book by Arun Sadhu</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5003</li>
					<li class="list-group-item">Charges per month(Rs) : 150</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
					<center>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="mukhvta.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Mukhvata</h5>
					<p class="card-text">A Book by Arun Sadhu</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5004</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="sambhaji maharaj.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Dharmaveer Chatrapati Sambhaji Maharaj</h5>
					<p class="card-text">A Book by Arun Jakhade </p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5005</li>
					<li class="list-group-item">Charges per month(Rs) : 170</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
					<center>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="in cold blood.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">In Cold Blood</h5>
					<p class="card-text">In Cold Blood is a non-fiction novel by American author Truman Capote</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 5006</li>
					<li class="list-group-item">Charges per month(Rs) : 90</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
					<center>
