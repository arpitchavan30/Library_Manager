	...
	<br>
		...
		<div class="educational-booksflex" id="educational-books">
			<div class="card my-card-styling " style="width: 18rem;">
				<img src="./mrutyunjay.jpg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Mrutyunjay</h5>
					<p class="card-text">A Book on great warrior 'Karn' by Shivaji Sawant</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2001</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="./yayati.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Yayati</h5>
					<p class="card-text">A Book by V.S. Khandekar</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2002</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="./panipat.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Panipat</h5>
					<p class="card-text">A book by Vishwas Patil</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2003</li>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="Wnigs of Fire.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Wings Of Fire</h5>
					<p class="card-text">A Book by Dr A.P.J. Abdul Kalam</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2004</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="shyamchiaai.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Shyam Chi Aai</h5>
					<p class="card-text">A book by Sane Guruji</p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2005</li>
					<li class="list-group-item">Charges per month(Rs) : 120</li>
					<li class="list-group-item">Status : Available</li>
				</ul>
				<div class="card-body">
					<center>
			...
			<div class="card my-card-styling" style="width: 18rem;">
				<img src="./Chhava.jpeg" class="card-img-top" alt="..."
					style="height: 18rem;">
				<div class="card-body">
					<h5 class="card-title">Chava</h5>
					<p class="card-text">A book by Shivaji Savant </p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Book ID : 2006</li>
					<li class="list-group-item">Charges per month(Rs) : 100</li>
					<li class="list-group-item"><h6 style="color: red ">Status : Not Available</h6></li>
				</ul>
				<div class="card-body">
					<center>
						<a href="Fiction.jsp" class="card-link">Issue</a>
					</center>
				</div>
			</div>
